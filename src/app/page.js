...
export default function Home() {
  ...
  const certificados = [
    ...
    { nome: 'JavaScript', progresso: 100, horas: '78 horas', link: 'https://www.devmedia.com.br/certificado/unificado/javascript/davi-351' },
  ...
  const projetos = [
    ...
    },
    {
      ...
      tecnologias: ['React - Next.JS (^16.0.10)', 'Node.js', 'JavaScript', 'API'],
